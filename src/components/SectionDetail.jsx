...
const SectionDetail = () => {
  return (
    <section className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="flex items-center border border-gray-300 rounded-lg p-4 gap-9">
        <div className="card1-section flex items-center justify-center">
      ...
      <div className="about-reserv grid grid-cols-1 sm:grid-cols-3 gap-4 ">
        <div className="aserv1 flex items-center">
          <FontAwesomeIcon icon={regularCalendar} className="text-gray-400 mr-2" />
          <h4 className="font-bold">Free cancellation before March 29</h4>
        </div>
        <div className="aserv2 flex items-center">
        ...
        <div className="aserv3 flex items-center">
          <FontAwesomeIcon icon={faPaw} className="text-gray-400 mr-2" />
          <div>
