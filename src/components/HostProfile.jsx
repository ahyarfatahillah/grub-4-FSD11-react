...
const HostProfile = ({ property }) => {
    // Mengambil data yang diperlukan dari property
    const { hostedDate } = property;

    // Fungsi untuk mengubah timestamp menjadi format tanggal yang diinginkan
                    ...
                    <div className="bg-white p-5 rounded-3xl flex justify-between items-center md:flex-col">
                        <div className="hostname flex flex-col">
                            <img
                                ...
                                src="https://a0.muscache.com/im/pictures/user/11c61521-ca89-4bd7-b00f-34d57d029641.jpg?im_w=240"
                                alt="Photo Profile"
                                width="100px"
                                height="100px"
                            />
                            <div className="text-center">
                                ...
                                <p className="text-[#757272]">{formatDate(hostedDate)}</p>
                            </div>
                        </div>
